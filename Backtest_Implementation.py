...
def process_row(row, time_interval, past_check_interval, trading_inteval, end_date, data_interval, fno_data,current_directory,csv_path):
    try:
...
if __name__ == '__main__':
    ...
    if user_input == "Y":
        past_check_interval = int(input("Enter past check interval: "))
        trading_inteval = int(input("Enter trading interval: "))
        time_interval = past_check_interval + trading_inteval
    else:
        past_check_interval = 2
        trading_inteval = 1
        time_interval = 3
    ...
    args = [(row, time_interval, past_check_interval, trading_inteval, end_date, data_interval, fno_data,current_directory,csv_path) 
